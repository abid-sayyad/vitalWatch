...
const Miner: React.FC<PropT> = ({ id }) => {
  ...
  return (
    <div className="grid grid-cols-2 mx-10 my-5 place-items-center gap-y-8 mt-11">
      <div className=" rounded border h-[340px] border-cyan-600 px-10 w-[600px] ">
      ...
      <div className=" h-fit flex rounded w-[600px]">
      ...
      <div className=" w-fit bg-gray-100 rounded my-2  sm:mx-2 mx-1 flex items-center">
        <ChartEmbed
          label="Air Quality"
          unit="ppm"
